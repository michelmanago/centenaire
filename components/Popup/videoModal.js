...
export default function VideoModal({url}) {
    ...
    return (
        <div>
            ...
            >
                {/* Icon */}
                <div className="absolute top-0 left-0 flex items-center justify-center w-full h-full hover:opacity-60">
            ...
            >
                <div className="relative p-1 bg-white border rounded">
                    {/* Close */}
                    <button
                    ...
                    <video
                        ...
                        src={url}
                        onPause={e => {
                            if (end && Math.round(e.target.currentTime) === parseInt(end)) {
