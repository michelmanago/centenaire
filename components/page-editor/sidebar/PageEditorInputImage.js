        ...
        <div className="">
            ...
            <div style={{minHeight: 200}} className={`flex flex-col`}>
                ...
                <div className={`flex-1 flex flex-col relative h-full hover:bg-gray-100 rounded-lg border border`}>
                    ...
                    {/* Loaded image */}
                    {src && <img className="block w-full object-contain rounded-lg" src={src} alt="" />}
                    
                    {/* Icon */}
                    {(!src && !isLoading) && (
                        <div className="relative z-10 w-full h-full flex-1 flex flex-col items-center justify-center cursor-pointer pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" className=" fill-current text-blue-600 w-1/5 h-1/5" viewBox="0 0 24 24" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M2 6H0v5h.01L0 20c0 1.1.9 2 2 2h18v-2H2V6zm5 9h14l-3.5-4.5-2.5 3.01L11.5 9zM22 4h-8l-2-2H6c-1.1 0-1.99.9-1.99 2L4 16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 12H6V4h5.17l1.41 1.41.59.59H22v10z"/></svg>
                    ...
                    {/* Loading upload */}
                    {
                        isLoading && (
                            <div className="flex-1 flex flex-col justify-center items-center">
                                <svg className="animate-spin -ml-1 mr-3 h-10 w-10 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            {/* Actions */}
            {
                src && (
                    <div>
                        ...
                        {/* Modifier */}
                        <label className="underline text-blue-500 mt-2 block cursor-pointer" htmlFor="inputMedia">Modifier l'image</label>
