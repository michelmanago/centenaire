...
export const sendResetPasswordEmail = ({toUser, hash}) => {
    const message = {
        ...
        html: `
            ...
            <p>Pour réinitialisation votre mot de passe, merci de suivre ce lien: <a target="_" href="${process.env.DOMAIN}/newpassword/${hash}">Réinitialisation du mot de passe</a></p>
            <p>Merci d'avance</p>
